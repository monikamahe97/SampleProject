...
public class MainActivity extends AppCompatActivity implements Adapter.OnClicktener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(view -> {
            ...
            File mydir = new File(Environment.getExternalStorageDirectory() + "/documents");
            if (!mydir.exists()) {
                mydir.mkdirs();
            }
            String url = "https://covidtest.xyramsoft.com/image/ticket-attachment/bbmp.png";
            ...
            request.setAllowedNetworkTypes(
                    ...
                    .setDestinationInExternalPublicDir(Environment.DIRECTORY_DOCUMENTS, ".jpg");
            manager.enqueue(request);
            String dirc = mydir.getAbsolutePath() + File.separator + ".jpg";
            Log.d("directory", "onCreate: " + dirc);
        });
